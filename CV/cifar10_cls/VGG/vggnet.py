...
class VGGbase(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(3, 64, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1)),
            nn.BatchNorm2d(64),
            nn.ReLU()
        )
        ...
        self.max_pooling3 = nn.MaxPool2d(kernel_size=2, padding=1, stride=2)
    ...
    def forward(self, x):
        ...
        # 这里可以将fc层换成卷积层
        out = self.fc(out)  # OUTPUT: batchsize * 10(分类个数)
